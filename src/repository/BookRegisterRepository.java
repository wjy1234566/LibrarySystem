...
public class BookRegisterRepository {
    ...
    public boolean addBook(String BookID,String BookName,String Author,String Price,String Publisher,Integer Quantity,String BookClass,String BookSurface){
        boolean check = false;
        ...
        try {
            ...
            if(!resultSet_query.next()){
                // SQL拼接
                String sql = "INSERT INTO book (book_id, book_name, author, price, publisher, quantity, book_class, book_surface) VALUES ('"+ BookID + "','" + BookName + "','" + Author + "','" + Price + "','" + Publisher + "','" + Quantity + "','" + BookClass + "','" + BookSurface + "');";
