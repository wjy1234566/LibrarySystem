...
<body class="gray-bg" body style="background-color:dodgerblue">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <%-- action 和 “/login” 映射 --%>
            <form class="m-t" role="form" action="/login" method="post" target="_parent">
                <div class="form-group">
                    <input name="ID" type="tel" class="form-control" placeholder="学号/教工号" required="">
        ...
        <a href="login_admin.jsp" style="color: white;" target="_parent"> 管理员登录 </a>
    </div>
</body>
